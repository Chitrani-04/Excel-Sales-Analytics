...
### Project Objectives:
   ...
   1. Create a [Customer Performance Report](https://github.com/Chitrani-04/Excel-Sales-Analytics/blob/main/Customer%20performance%20report.pdf) to analyze sales growth across customers from 2019–2021.

   2. Perform a [Market Performance vs Sales Target](https://github.com/Chitrani-04/Excel-Sales-Analytics/blob/main/Market%20Performance%20vs%20target.pdf) Analysis to identify gaps between actual sales and targets across regions and countries.
...
- Identify high-growth customers and markets
...
- Support discounting and pricing strategies

- Aid negotiations with key customers

- Highlight potential markets for geographic expansion
...
- Benchmark performance against prior periods

- Identify margin trends and cost pressures
